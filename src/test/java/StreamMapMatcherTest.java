...
//            System.out.println("--------------------------------");
            ...
            MapMatchedTrajectory mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.5);
            ...
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.0);
            ...
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.1);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
            System.out.println("beta:0.1 --- ACC:" + acc3);
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.2);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
            System.out.println("beta:0.2 --- ACC:" + acc3);
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.3);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
            System.out.println("beta:0.3 --- ACC:" + acc3);
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.4);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
            System.out.println("beta:0.4 --- ACC:" + acc3);
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.6);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
            System.out.println("beta:0.6 --- ACC:" + acc3);
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.7);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
            System.out.println("beta:0.7 --- ACC:" + acc3);
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.8);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
            System.out.println("beta:0.8 --- ACC:" + acc3);
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 0.9);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
            System.out.println("beta:0.9 --- ACC:" + acc3);
            mmTrajectory4 = mapMatcher2.streamMapMatch(trajectorySampleRate,0, 1.0);
            acc3 = EvaluateUtils.getAccuracy(mmTrajectory, mmTrajectory4,sampleRate);
            fix = (1 - acc3) * size;
            minValue = Math.min(fix , minValue);
...
//            System.out.println(mmTrajectory.toGeoJSON());
            ...
            for (double weight : weightList){
                mmTrajectory2 = mapMatcher2.streamMapMatch(trajectorySampleRate, 0, weight);
